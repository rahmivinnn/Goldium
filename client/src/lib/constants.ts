...
export const SOLANA_RPC_URL = 'https://api.devnet.solana.com'; // Use devnet for reliable testing
...
export const GOLDIUM_TOKEN_ADDRESS = 'GDfnEsia2WLAW5t8yx2X5j2mkfA74i5kwGdDuZHt7XmG'; // Real GOLDIUM token CA
...
// Exchange rates (based on real GOLD market data)
export const GOLD_TO_SOL_RATE = 0.00004422; // 1 GOLD = 0.00004422 SOL (real market price)
export const SOL_TO_GOLD_RATE = 1 / GOLD_TO_SOL_RATE; // 1 SOL = ~22,617 GOLD
